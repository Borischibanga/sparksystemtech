          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Name:</strong>: Farm Management System</li>
                <li><strong>Project Price</strong>: k10, 000</li>
                <li><strong>Project URL:</strong>: <a href="#">www.farmmanagement.com</a></li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>This  project is Available for any interested Client</h2>
              <p>
                This project helps you to manage your daily farm activiy ativities at your farm or business for effective productivity
        </p>
            </div>
          </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">sparksystemtech Company</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
